;(function () {
  var old = console.log
  var logger = document.getElementById('outputs')
  var text
...
particlesJS(
  'particles-js',
  {
    ...
    interactivity: { detect_on: 'canvas', events: { onhover: { enable: false }, onclick: { enable: true, mode: 'push' }, resize: true }, modes: { push: { particles_nb: 4 } } },
    retina_detect: true,
  },
  function () {}
)
